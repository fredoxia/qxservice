...
public class DefaultFunctionChain {
	...
	public static void load() {
		try {
			InputStream is = DefaultFunctionChain.class.getClassLoader()
					 .getResourceAsStream("sysParms/default-functions-chain.properties");
